...
window.DuraySite.data = {
  ...
  teachers: [
    ...
    { name: 'Carlos Fabrício Tavares Silva', modality: 'Treinamento Funcional e Defesa Pessoal Feminina', grade: 'Faixa-preta de Jiu-Jitsu — 2º DAN; prajied amarelo de Muay Thai', practiceYears: 'Pratica artes marciais desde os 10 anos', teachingYears: 'Atua como treinador desde 2021', biography: 'Formado em Educação Física desde 2021, Carlos Fabrício é pós-graduado em musculação e treinamento de força, com atuação voltada à hipertrofia e ao emagrecimento. Trabalha com treinamento funcional desde sua formação, ajudando seus alunos a alcançar excelentes resultados. Sua trajetória nas artes marciais começou aos 10 anos, com o judô. Posteriormente, migrou para o Jiu-Jitsu, modalidade na qual é faixa-preta 2º DAN. Atualmente também pratica Muay Thai, com prajied amarelo. A partir dessa experiência, passou a ministrar aulas de Defesa Pessoal Feminina, tema que considera especialmente importante nos dias atuais.', specialties: ['Treinamento Funcional', 'Defesa Pessoal Feminina', 'Musculação e treinamento de força', 'Jiu-Jitsu'], image: 'assets/images/teacher-carlos-fabricio.jpg', imageAlt: 'Professor Carlos Fabrício Tavares Silva com uniforme da Durāy Fight Club', isPlaceholder: false },
    { name: 'Maria Helena', modality: 'Ginástica Artística', grade: 'Professora de Educação Física', practiceYears: 'Vivencia a Ginástica Artística desde 2013', teachingYears: 'Atua como professora desde 2025', biography: 'Professora de Educação Física e especialista no ensino de Ginástica Artística, Maria Helena vivencia a modalidade desde 2013 como ginasta, experiência que impulsionou sua transição para a docência em 2025. Atuando na Durāy Fight Club desde 2026, une anos de prática ao conhecimento acadêmico da Educação Física. Sua metodologia é focada em consciência corporal, desenvolvimento motor, rigor técnico e fortalecimento da autoconfiança, buscando proporcionar um ambiente seguro, motivador e transformador para o desenvolvimento integral de seus alunos.', specialties: ['Ginástica Artística', 'Consciência corporal', 'Desenvolvimento motor', 'Fortalecimento da autoconfiança'], image: 'assets/images/teacher-maria-helena.jpg', imageAlt: 'Professora Maria Helena com uniforme da Durāy Fight Club', isPlaceholder: false },
    { name: 'Marcus Felipe', modality: 'Kickboxing', grade: '', practiceYears: 'Treina Kickboxing há 10 anos', teachingYears: '', biography: 'Marcus Felipe, mais conhecido como Felipinho Choque, treina Kickboxing há 10 anos e possui mais de 40 lutas, incluindo participações internacionais. É campeão do WRK Pro, maior evento de Kickboxing do Rio de Janeiro, nove vezes campeão carioca da modalidade e medalhista de prata no Sul-Americano de 2021 e no Pan-Americano de 2024. Leva para as aulas uma ampla experiência prática e competitiva na modalidade.', specialties: ['Kickboxing', 'Experiência competitiva', 'Competições nacionais e internacionais'], image: 'assets/images/teacher-marcus-felipe-v2.jpg', imageAlt: 'Professor Marcus Felipe com aparadores de Kickboxing na Durāy Fight Club', imagePosition: 'center 15%', isPlaceholder: false },
    { name: 'André Cordeiro', modality: 'Kickboxing — aulas da manhã', grade: '', practiceYears: '', teachingYears: '', biography: '', specialties: ['Kickboxing'], image: 'assets/images/teacher-andre-cordeiro.jpg', imageAlt: 'Professor André Cordeiro na área de treino da Durāy Fight Club', isPlaceholder: false },
    { name: 'Marcelo e Márcio Crispim', modality: 'Aikido', grade: '', practiceYears: '', teachingYears: '', biography: '', specialties: [], image: 'assets/images/teachers-marcelo-marcio-crispim.jpg', imageAlt: 'Professores Marcelo Crispim, à esquerda, e Márcio Crispim, à direita, com uniformes de Aikido', imageFit: 'contain', isPlaceholder: false },
    { name: 'Vinícius Paravidino', modality: 'Boxe', grade: 'Treinador certificado pela Federação de Boxe do Estado do Rio de Janeiro', practiceYears: 'Treina Boxe desde 2016', teachingYears: 'Treinador certificado desde 2021', biography: 'Meu nome é Vinícius Paravidino. Treino Boxe desde 2016, sou treinador certificado pela Federação de Boxe do Estado do Rio de Janeiro desde 2021 e, atualmente, atuo pela Associação Brasileira de Pugilismo. Ao longo dessa trajetória, acompanho de perto como o Boxe vai muito além da preparação física: trata-se de uma modalidade fantástica para o desenvolvimento psicomotor, impactando diretamente o controle corporal, a percepção espacial e a resposta cognitiva sob pressão. A prática integra corpo e mente ao exigir máxima precisão, disciplina e consciência mecânica em cada movimento. Dessa forma, o Boxe se consolida como uma arte marcial de combate e uma ferramenta completa de desenvolvimento humano, capaz de transformar capacidades motoras, cognitivas e socioemocionais de seus praticantes.', specialties: ['Boxe', 'Desenvolvimento psicomotor', 'Preparação física'], image: 'assets/images/teacher-vinicius-paravidino.jpg', imageAlt: 'Professor Vinícius Paravidino em uma escola de Boxe', imagePosition: 'center 38%', isPlaceholder: false },
  ],
  schedule: [
