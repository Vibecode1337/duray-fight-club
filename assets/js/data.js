...
window.DuraySite.data = {
  ...
  teachers: [
    ...
    { name: 'Marcus Felipe', modality: 'Kickboxing', grade: '', practiceYears: 'Treina Kickboxing há 10 anos', teachingYears: '', biography: 'Marcus Felipe, mais conhecido como Felipinho Choque, treina Kickboxing há 10 anos e possui mais de 40 lutas, incluindo participações internacionais. É campeão do WRK Pro, maior evento de Kickboxing do Rio de Janeiro, nove vezes campeão carioca da modalidade e medalhista de prata no Sul-Americano de 2021 e no Pan-Americano de 2024. Leva para as aulas uma ampla experiência prática e competitiva na modalidade.', specialties: ['Kickboxing', 'Experiência competitiva', 'Competições nacionais e internacionais'], image: 'assets/images/teacher-marcus-felipe.jpg', imageAlt: 'Professor Marcus Felipe com aparadores de Kickboxing na Durāy Fight Club', isPlaceholder: false },
